...
// This file contains the definitions of all SEO elements to be analyzed
export const seoElements: SeoElementDefinition[] = [
  ...
  // Additional elements would be defined here in a similar pattern
  {
...
// Helper function to get only the SEO elements needed for display (without the check function)
export const getSeoElementsForDisplay = () => {
  return seoElements.map(({ id, name, weight }) => ({
    id,
    name,
    weight,
    score: 0,
